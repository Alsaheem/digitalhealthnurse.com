    ...
    <div className="min-h-screen bg-[#FFF9F4] text-[#243332]">
        ...
        <div className="mx-auto max-w-[90rem] px-5 py-4 sm:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:justify-end">
              ...
              <a
                href="#mentoring"
                className="inline-flex min-h-11 items-center rounded-full bg-[#174E4F] px-5 py-2.5 text-[0.95rem] font-semibold text-white shadow-sm transition-all hover:bg-[#123E3F] hover:shadow-md"
              >
                Book a Session
              </a>
              <a
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#FFF9F4_0%,#FFF9F4_50%,#F7DED4_100%)]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-14 text-center sm:px-8 md:py-18 lg:py-20">
          ...
          <h1 className="font-hero-serif mx-auto mb-7 max-w-[53rem] text-[2.5rem] font-bold leading-[1.08] tracking-[-0.025em] text-[#174E4F] md:text-[2.875rem] lg:text-[3.75rem]">
            Move Beyond Clinical Practice Without Starting From Scratch
          </h1>

          <p className="mx-auto mb-9 max-w-[47.5rem] text-[1.1875rem] leading-8 text-[#243332]/85">
            Practical, personalised mentoring for nurses and healthcare professionals
            who want to understand where their experience fits across digital health,
            health informatics, customer success and other non-clinical careers.
          </p>

          <div className="flex flex-col justify-center gap-4 sm:flex-row sm:flex-wrap">
            <a
              href="#mentoring"
              className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#174E4F] px-8 py-4 text-base font-bold text-white shadow-[0_10px_25px_rgba(23,78,79,0.18)] transition-all hover:-translate-y-0.5 hover:bg-[#123E3F] hover:shadow-[0_14px_30px_rgba(23,78,79,0.24)]"
            >
            ...
            <a
              href="#about"
              className="inline-flex min-h-12 items-center justify-center rounded-full border-2 border-[#D96F59] bg-[#FFFFFF]/70 px-8 py-4 text-base font-bold text-[#174E4F] shadow-sm transition-all hover:-translate-y-0.5 hover:bg-[#F7DED4]"
            >
              Meet Stacy
            </a>
          </div>
      ...
      <section id="skills" className="mx-auto max-w-6xl px-6 py-20 scroll-mt-20 md:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2 md:gap-8">
          <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#DDE9E2] bg-white p-8 shadow-[0_12px_32px_rgba(23,78,79,0.08)] transition-[border-color,box-shadow] hover:border-[#B9D0C3] hover:shadow-[0_16px_38px_rgba(23,78,79,0.12)] md:p-10">
            <div aria-hidden="true" className="absolute left-8 top-0 h-1 w-16 rounded-b-full bg-[#D96F59]" />
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#DDE9E2] text-[#174E4F]">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <h3 className="mb-4 text-2xl font-bold leading-tight text-[#174E4F]">
              Which Roles Could Fit Your Experience?
            </h3>
            <p className="text-base leading-7 text-[#516361]">
              Explore opportunities across digital health, health informatics,
              customer success and other non-clinical healthcare careers. We will
              consider which directions may be worth investigating based on your
              experience, interests and priorities.
            </p>
          </div>

          <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#DDE9E2] bg-[#FFFCF9] p-8 shadow-[0_12px_32px_rgba(23,78,79,0.08)] transition-[border-color,box-shadow] hover:border-[#B9D0C3] hover:shadow-[0_16px_38px_rgba(23,78,79,0.12)] md:p-10">
            <div aria-hidden="true" className="absolute left-8 top-0 h-1 w-16 rounded-b-full bg-[#D96F59]" />
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F7DED4] text-[#174E4F]">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <h3 className="mb-4 text-2xl font-bold leading-tight text-[#174E4F]">
              Translate Your Healthcare Experience
            </h3>
            <p className="text-base leading-7 text-[#516361]">
              Recognise the transferable strengths you have developed in healthcare
              and learn how to explain their relevance clearly when exploring roles
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#DDE9E2] bg-[#FFFCF9] p-8 shadow-[0_12px_32px_rgba(23,78,79,0.08)] transition-[border-color,box-shadow] hover:border-[#B9D0C3] hover:shadow-[0_16px_38px_rgba(23,78,79,0.12)] md:p-10">
            ...
            <h3 className="mb-4 text-2xl font-bold leading-tight text-[#174E4F]">
              Strengthen Your CV, LinkedIn and Interview Story
            </h3>
            <p className="text-base leading-7 text-[#516361]">
              Receive focused guidance on presenting your experience, improving your
              professional positioning and explaining your career transition with
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#DDE9E2] bg-white p-8 shadow-[0_12px_32px_rgba(23,78,79,0.08)] transition-[border-color,box-shadow] hover:border-[#B9D0C3] hover:shadow-[0_16px_38px_rgba(23,78,79,0.12)] md:p-10">
            ...
            <h3 className="mb-4 text-2xl font-bold leading-tight text-[#174E4F]">
              Build a Focused Career Action Plan
            </h3>
            <p className="text-base leading-7 text-[#516361]">
              Turn broad ideas into realistic next steps, including roles to
              research, development priorities, networking and a more focused
      ...
      <section
        id="projects"
        className="bg-[#174E4F] scroll-mt-20"
      >
          ...
          <div className="grid md:grid-cols-2">
            <div className="flex gap-5 pb-8 md:pr-10">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="mt-1 h-6 w-6 shrink-0 text-[#D96F59]"
              >
            ...
            <div className="flex gap-5 border-t border-[#DDE9E2]/25 pt-8 md:border-l md:pl-10">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="none"
      ...
      >
        ...
        <div className="grid items-start gap-8 md:grid-cols-2">
          {/* Introductory Call */}
          <div className="rounded-3xl border border-[#C8D8CF] bg-[#FFFCF9] p-8 shadow-[0_12px_32px_rgba(23,78,79,0.08)] md:p-10">
            ...
            <ul className="mb-6 space-y-4">
              <li className="flex gap-3 text-base leading-7 text-[#243332]">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="mt-1 h-5 w-5 shrink-0 text-[#174E4F]"
                >
                  <path d="m5 12 4 4L19 6" />
                </svg>
            ...
            <a
              ...
              className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#174E4F] px-8 py-4 text-base font-bold text-white shadow-[0_10px_25px_rgba(23,78,79,0.18)] transition-all hover:bg-[#123E3F] hover:shadow-[0_14px_30px_rgba(23,78,79,0.24)]"
            >
          ...
          <div className="relative rounded-3xl border-2 border-[#174E4F] bg-[#174E4F] p-8 shadow-[0_18px_45px_rgba(23,78,79,0.20)] md:p-10">
            ...
            <div className="mb-7">
              <p className="mb-1 text-sm font-semibold text-[#F7DED4]">
                Introductory price
              </p>
              <p className="text-5xl font-bold tracking-tight text-[#FFF9F4]">£25</p>
            </div>
            ...
            <ul className="mb-7 space-y-4">
              <li className="flex gap-3 text-base leading-7 text-[#FFF9F4]">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="mt-1 h-5 w-5 shrink-0 text-[#D96F59]"
                >
                  <path d="m5 12 4 4L19 6" />
                </svg>
                <span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#FFF9F4] px-8 py-4 text-base font-bold text-[#174E4F] shadow-[0_10px_25px_rgba(0,0,0,0.15)] transition-all hover:bg-white hover:shadow-[0_14px_30px_rgba(0,0,0,0.20)]"
            >
          ...
          <div className="grid gap-10 lg:grid-cols-4 lg:gap-8">
            <div className="relative flex gap-5 lg:block lg:text-center">
              ...
              <div>
                ...
                <p className="text-base leading-7 text-[#516361]">
                  Book the free introductory call if you are still deciding whether
                  mentoring is suitable, or choose the Career Strategy Session when
                  you are ready for focused support.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex gap-5 lg:block lg:text-center">
              ...
              <div>
                <h3 className="mb-3 text-xl font-bold leading-tight text-[#174E4F]">
                  Share Your Career Context
                </h3>
                <p className="text-base leading-7 text-[#516361]">
                  Before the session, provide brief information about your current
                  role, the change you are considering and what you would most like
                  help with.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex gap-5 lg:block lg:text-center">
              ...
              <div>
                ...
                <p className="text-base leading-7 text-[#516361]">
                  We will explore your experience, transferable skills, possible
                  career directions and the challenges affecting your next move.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex gap-5 lg:block lg:text-center">
              ...
              <div>
                ...
                <p className="text-base leading-7 text-[#516361]">
                  We will identify practical priorities to help you continue
                  researching, positioning and planning your career transition.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 text-center sm:px-8 md:py-24">
          ...
          <div className="flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-12 items-center justify-center rounded-full border-2 border-[#174E4F] bg-[#FFF9F4]/70 px-8 py-4 text-base font-bold text-[#174E4F] transition-all hover:bg-[#FFF9F4]"
            >
              Book a Free Introductory Call
            </a>
          </div>
